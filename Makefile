...
DCAP_QGS_SELECTOR ?= app=intel-tdx-qgs
DCAP_PCK_EXPIRE_HOURS ?= 8760
DCAP_QGS_TIMEOUT ?= 10m
export DCAP_PCSCLIENT_REPO DCAP_PCSCLIENT_DIR DCAP_PCSCLIENT_REF DCAP_PCK_DIR DCAP_REQUEST_BUNDLE DCAP_RESPONSE_BUNDLE DCAP_NAMESPACE DCAP_QGS_SELECTOR DCAP_PCK_EXPIRE_HOURS DCAP_QGS_TIMEOUT
