...
export MIRROR_REGISTRY=172.25.36.135:8443   # host:port of your mirror registry
...
export MIRROR_REGISTRY=172.25.36.135:8443   # mirror-registry host:port
export GIT_SERVER=http://172.25.36.135:8080  # local git HTTP server
...
labctl generate \
  ...
  --http-serve-path /home/chbutler/public_html/ \
  2>&1 | tee -a "$LOG"
...
ca = open('/home/chbutler/mirror-registry-certs/ca.crt').read()
import os; mreg_host = os.environ.get('MIRROR_REGISTRY','172.25.36.135:8443').split(':')[0]
...
export MIRROR_REGISTRY=172.25.36.135:8443
```
...
credentials for 172.25.36.135:8443. Without this, cluster nodes cannot pull images redirected
