...
export MIRROR_REGISTRY=10.0.0.1:8443   # host:port of your mirror registry
...
export MIRROR_REGISTRY=10.0.0.1:8443   # mirror-registry host:port
export GIT_SERVER=http://10.0.0.1:8080  # local git HTTP server
...
import os; mreg_host = os.environ.get('MIRROR_REGISTRY','10.0.0.1:8443').split(':')[0]
...
export MIRROR_REGISTRY=10.0.0.1:8443
```
...
credentials for 10.0.0.1:8443. Without this, cluster nodes cannot pull images redirected
